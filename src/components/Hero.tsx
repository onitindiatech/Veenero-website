      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-7xl font-bold text-primary-foreground leading-tight mb-8 opacity-0 animate-fade-up animation-delay-200">
            ...
            <span className="block mt-2 bg-clip-text text-transparent bg-gradient-to-r from-primary-foreground via-aqua to-primary-foreground animate-gradient">Future Together</span>
          </h1>
          <p className="text-lg md:text-xl text-primary-foreground/85 max-w-2xl mx-auto mb-10 leading-relaxed opacity-0 animate-fade-up animation-delay-400">
            From water conservation to energy efficiency and waste reduction, we deliver cutting-edge technology solutions that drive environmental impact across every sector.
          </p>
