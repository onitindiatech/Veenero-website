...
export const ImpactCTA: React.FC<ImpactCTAProps> = ({ data }) => {
  ...
  const description =
    data?.description ||
    "Partner with Veenero to deploy verification-ready water intelligence across your facility network and transform unmetered blindspots into verified ESG outcomes.";

  const primaryButtonText = "Talk to Veenero";
  const primaryButtonLink = data?.primaryButtonLink || "/contact";
  const secondaryButtonText = "Explore Solutions";
          ...
          <div className="relative z-10 text-left max-w-xl space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3.5">
              ...
              <Link
                ...
                className="px-7 py-3.5 bg-white/5 hover:bg-white/10 text-white border border-white/25 hover:border-white/40 rounded-full font-semibold transition-all duration-200 text-sm flex items-center justify-center gap-2"
              >
