    ...
    heroHighlights: [
      {
        icon: "ShieldCheck",
        title: "Award-Winning",
        subtitle: "Intinta Innovator",
      },
      {
        icon: "Cpu",
        title: "Zero Cutting",
        subtitle: "Rapid Retrofit",
      },
      {
        icon: "Zap",
        title: "Sub-2s Trip",
        subtitle: "Auto Cutoff",
      },
    ],
    problemSection: {
      ...
      impactSummary: "Over 40% of pumped municipal and groundwater is lost to preventable distribution leaks and unmanaged tank overflows.",
      items: [
        {
          icon: "AlertTriangle",
      ...
      metrics: [
        {
          ...
          description:
            "Average volumetric loss eliminated across pipeline joints, tap drips, and overflow incidents.",
        },
        {
          target: 2,
          prefix: "< ",
          ...
          description:
            "Instant pump shutoff or motorized valve trip upon detecting abnormal discharge or overflow.",
        },
        {
          target: 100,
          suffix: "%",
          ...
          description:
            "Completely eradicates overhead tank overflow spills through automated motor controller triggers.",
        },
        {
          target: 30,
          suffix: "%",
          ...
          description:
            "Eliminates redundant pumping runtimes and optimizes motor efficiency based on real-time reservoir levels.",
        },
        {
          target: 4,
          suffix: " Mos",
          ...
          description:
            "Rapid return on investment achieved through eliminated water tanker purchases and reduced power bills.",
        },
        {
          target: 2,
          suffix: " Yrs",
          ...
          description:
            "Recognized by state innovation authorities for outstanding grassroots water conservation hardware.",
        },
      ],
    },
    analyticsVisual: {
      ...
      stats: [
        { label: "Active Monitored Lines", value: "1,420+", numericValue: 1420, change: "All Units Healthy" },
        { label: "Daily Water Saved", value: "2.4M L", numericValue: 2.4, suffix: "M Litres", change: "+12.4% vs Baseline" },
        { label: "Mean Trip Response", value: "1.4s", numericValue: 1.4, suffix: "s", change: "Sub-2s Threshold" },
        { label: "System Uptime", value: "99.94%", numericValue: 99.94, suffix: "%", change: "High Availability" },
      ],
    },
    useCases: {
...
export function getSolutionBySlug(slug?: string): SolutionDetailData {
  if (!slug) return solutionDetailsMap["aqua-saver"] || solutionDetailsMap["water-accountability"];
  const normalized = slug.toLowerCase().trim();

  // Authentic Veenero source slugs
  if (normalized === "aqua-saver") {
    return solutionDetailsMap["aqua-saver"];
  }
